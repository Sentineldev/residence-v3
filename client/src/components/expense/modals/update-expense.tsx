...
export default function UpdateExpenseModal({ onCreatedHandler, expense, selectExpense }: UpdateExpenseModalProps) {
    ...
    async function onSubmitHandler(e: Event & {
        ...
        const response = await ExpenseAPI.update(expense.ID, {
    ...
    return (
        ...
        <dialog onClose={() => selectExpense(undefined, 'NONE')} id="update-expense-modal" class="rounded-lg relative">
