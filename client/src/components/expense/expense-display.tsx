...
export default function ExpenseDisplay({ expense,  selectExpense}: ExpenseDisplayProps) {
    ...
    return (
        <div class="grid grid-cols-5 border-b py-2">
            <div>
            ...
            <div class="flex gap-4">
                <button onclick={onSelectHandler} class="bg-blue-400 p-2 rounded-lg">
                ...
                <button onclick={onSelectHandler} class="bg-red-500 p-2 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0,0,256,256">
