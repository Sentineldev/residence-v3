...
export default function ExpenseStats({ stats }: ExpenseStatsProps) {
    ...
    return (
        <div class="grid lg:grid-cols-2 gap-4 h-full">
            <div class="shadow-2xl bg-primary border-none h-full p-4 px-8 flex gap-4 rounded-lg">
                <div class="flex flex-col flex-1 gap-2">
                    <header class="font-semibold text-lg lg:text-2xl flex-1 opacity-80  text-secondary ">Total Gasto Real</header>
                    <p class="flex-1 text-lg lg:text-2xl font-bold text-secondary">{stats.Real.toLocaleString()} $</p>
                    {/* <footer class="text-lg">Promedio 30.50</footer> */}
                </div>
                <div class="self-center px-4">
                    <svg xmlns="http://www.w3.org/2000/svg"  width={48} height={48} viewBox="0 0 48 48"><g fill="#0a210f" id="Layer_2" data-name="Layer 2"><g id="layer_1-2" data-name="layer 1">
            ...
            <div class="shadow-2xl bg-primary h-full p-4 px-8 gap-4 flex rounded-lg">
                <div class="flex flex-col flex-1 gap-2">
                    <header class="font-bold text-lg lg:text-2xl flex-1 opacity-80 text-secondary">Total Gasto Estimado</header>
                    <p class="flex-1 text-lg lg:text-2xl font-bold text-secondary">{stats.Estimated.toLocaleString()} $</p>
                    {/* <footer class="text-lg">Promedio 30.50</footer> */}
                </div>
                <div class="self-center px-4">
                    <svg xmlns="http://www.w3.org/2000/svg"  width={48} height={48} viewBox="0 0 48 48"><g fill="#0a210f" id="Layer_2" data-name="Layer 2"><g id="layer_1-2" data-name="layer 1">
